...
describe('create request handler', () => {
  ...
  describe('when there are validation errors', () => {
    ...
    beforeEach(() => {
      validateImageCreateEvent.mockImplementationOnce(() => {
  ...
  describe('when error has been thrown while creating an image', () => {
    const expectedInputErr = new RecordNotFound()
    beforeEach(() => {
      validateImageCreateEvent.mockReturnValueOnce({})
